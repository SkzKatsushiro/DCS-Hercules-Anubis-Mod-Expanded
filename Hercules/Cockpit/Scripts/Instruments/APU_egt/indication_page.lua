...
APU_egt_origin.use_mipfilter    = true
APU_egt_origin.additive_alpha   = true
APU_egt_origin.h_clip_relation  = h_clip_relations.COMPARE
APU_egt_origin.level			= DISPLAY_DEFAULT_LEVEL
Add(APU_egt_origin)

Add_Object_Text(APU_egt, "APU_egt", APU_egt_origin.name,
